...
from src.utils.state_manager import StateManager, get_state_manager
...
class TestVideoMarkMethods:
    ...
    def test_mark_clips_generated(self, tmp_project_dir):
        ...
        clips = [{"clip_id": 1, "start": 0, "end": 60}, {"clip_id": 2, "start": 60, "end": 120}]
...
class TestAutoGeneratedName:
    ...
    def test_get_auto_generated_name(self, tmp_project_dir):
        ...
        assert manager.get_auto_generated_name("get_name_test") == "Machine Learning Basics"
...
class TestJobQueueOperations:
    ...
    def test_get_job_status(self, tmp_project_dir):
        ...
        manager.enqueue_job(job_spec, initial_status={"state": "pending", "progress": 0})
